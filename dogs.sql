...
INSERT INTO `dog_records` (`dog_id`, `dog_name`, `dog_breed`, `dog_birthdate`, `dog_age`, `dog_weight`, `owner_name`, `owner_phone`, `vaccination_status`, `img_dir`) VALUES
(16, 'Bailey', 'Beagler', '2021-03-27', 3, 13.10, 'Monica Old', '555', 'Expired', 'uploads/'),
...
--
ALTER TABLE `dog_records`
  MODIFY `dog_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=227;
COMMIT;
